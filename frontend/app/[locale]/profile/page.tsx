...
export default function ProfilePage() {
  ...
  const mockUser = {
    email: "demo@folkspace.app",
    uid: "demo-user-12345",
    displayName: "Demo User"
  };

  // Get the first letter of the email for the avatar placeholder
  const emailInitial = mockUser.email ? mockUser.email[0].toUpperCase() : "?";
  ...
  return (
    ...
    <div className="flex min-h-screen items-center justify-center bg-bg-night p-4">
      ...
      >
        ...
        {/* Demo Notice */}
        <div className="mb-6 p-4 bg-[#00F2A9]/10 border border-[#00F2A9]/30 rounded-lg">
          <p className="text-sm text-[#00F2A9] font-medium">
            🎯 Portfolio Demo Mode
          </p>
          <p className="text-xs text-text-secondary mt-1">
            This is a demonstration profile for portfolio purposes
          </p>
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full rounded-lg bg-gradient-to-r from-[#00F2A9] to-[#00F2A9] 
                       py-3 px-6 text-base font-semibold text-black shadow-lg
                       transition-opacity hover:opacity-90 
                       hover:shadow-[0_4px_15px_rgba(0,242,169,0.3)]"
          >
            View Dashboard
          </button>
